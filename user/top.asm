...
{
   0:	8c010113          	addi	sp,sp,-1856
   4:	72113c23          	sd	ra,1848(sp)
   8:	72813823          	sd	s0,1840(sp)
   c:	72913423          	sd	s1,1832(sp)
  10:	73213023          	sd	s2,1824(sp)
  14:	71313c23          	sd	s3,1816(sp)
  18:	71413823          	sd	s4,1808(sp)
  1c:	74010413          	addi	s0,sp,1856
    };
  ...
  24:	88050513          	addi	a0,a0,-1920 # 8a0 <malloc+0xe8>
  28:	00000097          	auipc	ra,0x0
  2c:	6d2080e7          	jalr	1746(ra) # 6fa <printf>
    printf("%d\n",t.total);
  30:	8c442583          	lw	a1,-1852(s0)
  34:	00001517          	auipc	a0,0x1
  38:	88450513          	addi	a0,a0,-1916 # 8b8 <malloc+0x100>
  3c:	00000097          	auipc	ra,0x0
  40:	6be080e7          	jalr	1726(ra) # 6fa <printf>
    printf("running process : ");
  44:	00001517          	auipc	a0,0x1
  48:	87c50513          	addi	a0,a0,-1924 # 8c0 <malloc+0x108>
  4c:	00000097          	auipc	ra,0x0
  50:	6ae080e7          	jalr	1710(ra) # 6fa <printf>
    printf("%d\n",t.running);
  54:	8c042583          	lw	a1,-1856(s0)
  58:	00001517          	auipc	a0,0x1
  5c:	86050513          	addi	a0,a0,-1952 # 8b8 <malloc+0x100>
  60:	00000097          	auipc	ra,0x0
  64:	69a080e7          	jalr	1690(ra) # 6fa <printf>
    printf("waiting process : ");
  68:	00001517          	auipc	a0,0x1
  6c:	87050513          	addi	a0,a0,-1936 # 8d8 <malloc+0x120>
  70:	00000097          	auipc	ra,0x0
  74:	68a080e7          	jalr	1674(ra) # 6fa <printf>
    printf("%d\n",t.waiting);
  78:	8c842583          	lw	a1,-1848(s0)
  7c:	00001517          	auipc	a0,0x1
  80:	83c50513          	addi	a0,a0,-1988 # 8b8 <malloc+0x100>
  84:	00000097          	auipc	ra,0x0
  88:	676080e7          	jalr	1654(ra) # 6fa <printf>

    printf("NAME\tPID\tPPID\tSTATE\n");
  8c:	00001517          	auipc	a0,0x1
  90:	86450513          	addi	a0,a0,-1948 # 8f0 <malloc+0x138>
  94:	00000097          	auipc	ra,0x0
  98:	666080e7          	jalr	1638(ra) # 6fa <printf>
    for (int i = 0; i < t.total; ++i) {
  9c:	8c442783          	lw	a5,-1852(s0)
  a0:	04f05063          	blez	a5,e0 <main+0xe0>
  a4:	8cc40493          	addi	s1,s0,-1844
  a8:	4901                	li	s2,0
        printf("%s\t%d\t%d\t%s\n", t.info[i].name, t.info[i].pid, t.info[i].ppid, states[t.info[i].state]);
  aa:	00001a17          	auipc	s4,0x1
  ae:	8b6a0a13          	addi	s4,s4,-1866 # 960 <states.0>
  b2:	00001997          	auipc	s3,0x1
  b6:	85698993          	addi	s3,s3,-1962 # 908 <malloc+0x150>
  ba:	0184e783          	lwu	a5,24(s1)
  be:	078e                	slli	a5,a5,0x3
  c0:	97d2                	add	a5,a5,s4
  c2:	6398                	ld	a4,0(a5)
  c4:	48d4                	lw	a3,20(s1)
  c6:	4890                	lw	a2,16(s1)
  c8:	85a6                	mv	a1,s1
  ...
  d0:	62e080e7          	jalr	1582(ra) # 6fa <printf>
    for (int i = 0; i < t.total; ++i) {
  d4:	2905                	addiw	s2,s2,1
  d6:	04f1                	addi	s1,s1,28
  d8:	8c442783          	lw	a5,-1852(s0)
  dc:	fcf94fe3          	blt	s2,a5,ba <main+0xba>
    }
    exit(0);
  e0:	4501                	li	a0,0
  e2:	00000097          	auipc	ra,0x0
  e6:	290080e7          	jalr	656(ra) # 372 <exit>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 536:	466b8b93          	addi	s7,s7,1126 # 998 <digits>
 ...
 676:	31e90913          	addi	s2,s2,798 # 990 <states.0+0x30>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 890:	b6e080e7          	jalr	-1170(ra) # 3fa <sbrk>
  if(p == (char*)-1)
